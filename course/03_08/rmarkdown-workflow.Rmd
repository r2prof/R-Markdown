...
[RMarkdown](http://rmarkdown.rstudio.com) is a collection of technologies that allow useRs to create rich documents or slides that include text, code, images and the potential for interactive content.
...
You make bold text with \*\*asteriks\*\*
